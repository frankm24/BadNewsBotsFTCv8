...
@Autonomous
public final class AutoBlue1OneCone extends LinearOpMode {
    ...
    private TrajectorySequence blueAutoOneCone1_1;
    private TrajectorySequence blueAutoOneCone2_2;
    private TrajectorySequence blueAuto2OneCone2_3;
    ...
    public void runOpMode() {
        ...
        if (coneOrientation == SignalSleevePipeline.ConeOrientation.ONE) {
            drive.followTrajectorySequence(blueAutoOneCone1_1);
        }
